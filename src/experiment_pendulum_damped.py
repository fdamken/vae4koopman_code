...
@ex.capture
def sample_dynamics(t_final: float, T: int, N: int, h: float, param_damping: float, initial_value_mean: np.ndarray, initial_value_cov: np.ndarray, R: np.ndarray) -> \
